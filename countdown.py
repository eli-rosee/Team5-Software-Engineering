...
class CountdownWindow(QMainWindow):
    ...
    def setup_background(self):
        ...
        background_path = "graphics/background.tif"
    ...
    def update_image(self):
        ...
        image_path = f"graphics/countdown_images/countdown_{self.countdown_time}.jpg"
    ...
    def show_final_image(self):
        """Displays the final 'countdown_0.jpg' before transitioning."""
        final_image_path = "graphics/countdown_images/countdown_0.jpg"
    ...
    def launch_next_screen(self):
        ...
        import player_entry_screen  # Import here to avoid circular imports
        self.next_screen = player_entry_screen.PlayerEntryScreen()
